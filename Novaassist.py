...
print('Loading your AI personal assistant NOVA')
...
speak("iam your AI personal assistant Nova")
wishMe()
...
if __name__=='__main__':
    ...
    while True:
        ...
        if statement==0:
            ...
            speak('your personal assistant Nova is shutting down,Good bye')
            print('your personal assistant Nova is shutting down,Good bye')
            break
            ...
            speak("iam Nova your voice assistant built and developed by Gokulan")
            ...
            speak("My boss is gokulan")
        elif 'time' in statement:
            strTime=datetime.datetime.now().strftime("%H:%M:%S")
            speak(f"the time is {strTime}")

        elif 'who are you' in statement or 'what can you do' in statement:
            speak('I am Nova version 1 point O your persoanl assistant. I am programmed to minor tasks')
                 

        elif "who made you" in statement or "who created you" in statement or "who discovered you" in statement:
            speak("I was built by gokulan")
            print("I was built by gokulan")
